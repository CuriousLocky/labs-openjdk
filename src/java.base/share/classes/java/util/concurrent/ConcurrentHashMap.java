...
public class ConcurrentHashMap<K,V> extends AbstractMap<K,V>
    ...
    static class Node<K,V> implements Map.Entry<K,V> {
        ...
        public final boolean equals(Object o) {
            ...
            return ((o instanceof Map.Entry) &&
                    ...
                    (v = e.getValue()) != null &&
                    (k == key || k.specialEquals(key)) &&
                    (v == (u = val) || v.specialEquals(u)));
        }
        ...
        Node<K,V> find(int h, Object k) {
            ...
            if (k != null) {
                do {
                    K ek;
                    if (e.hash == h &&
                        ((ek = e.key) == k || (ek != null && k.specialEquals(ek))))
                        return e;
                } while ((e = e.next) != null);
            }
            return null;
    ...
    public V get(Object key) {
        ...
        if ((tab = table) != null && (n = tab.length) > 0 &&
            ...
            if ((eh = e.hash) == h) {
                if ((ek = e.key) == key || (ek != null && key.specialEquals(ek)))
                    return e.val;
            }
            else if (eh < 0)
            ...
            while ((e = e.next) != null) {
                if (e.hash == h &&
                    ((ek = e.key) == key || (ek != null && key.specialEquals(ek))))
                    return e.val;
            }
        }
        return null;
    ...
    public boolean containsValue(Object value) {
        ...
        if ((t = table) != null) {
            ...
            for (Node<K,V> p; (p = it.advance()) != null; ) {
                V v;
                if ((v = p.val) == value || (v != null && value.specialEquals(v)))
                    return true;
            }
        }
        return false;
        ...
        for (Node<K,V>[] tab = table;;) {
            ...
            if (tab == null || (n = tab.length) == 0)
                ...
                tab = helpTransfer(tab, f);
                     ...
                     && fh == hash
                     && ((fk = f.key) == key || (fk != null && key.specialEquals(fk)))
                     && (fv = f.val) != null)
                return fv;
            else {
                V oldVal = null;
    ...
    public boolean equals(Object o) {
        if (o != this) {
            ...
            for (Node<K,V> p; (p = it.advance()) != null; ) {
                ...
                if (v == null || (v != val && !v.specialEquals(val)))
                    return false;
            }
            ...
            if (k != null) {
                ...
                do {
                    ...
                    if ((ph = p.hash) > h)
                        ...
                        p = pr;
                    else if ((pk = p.key) == k || (pk != null && k.specialEquals(pk)))
                        return p;
                    else if (pl == null)
                        p = pr;
                    else if (pr == null)
